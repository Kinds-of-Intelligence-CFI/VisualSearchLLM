...
parser.add_argument("--model", required=True, help="Model name, e.g., Llama11B")
parser.add_argument("--directory", default=".", help="Directory containing the response files")
...
pattern = os.path.join(directory, f"{model}_responses*.jsonl")
...
combined_filename = os.path.join(directory, f"{model}_combined_batch_responses.json")
